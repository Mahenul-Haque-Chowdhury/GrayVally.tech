    ...
    <div className="min-h-screen bg-background text-text-primary">
      ...
      <main className="w-full">
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 px-8 py-3 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white font-semibold transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
                  >
        ...
        <section id="features" className="relative px-4 py-16 sm:py-24 border-t border-border bg-gradient-to-b from-transparent via-cyan-500/5 to-transparent">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold text-center mb-4">Powerful Features</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Custom Join Sounds */}
              <div className="group p-6 rounded-xl border border-cyan-500/20 bg-cyan-500/5 hover:bg-cyan-500/10 transition-all">
                <div className="flex items-start gap-4">
                  <div className="p-3 rounded-lg bg-cyan-500/20 text-cyan-400 group-hover:text-cyan-300">
                    <Music className="h-6 w-6" />
                  </div>
                  <div className="flex-1">
                    <h3 className="font-semibold mb-2">Custom Join Sounds</h3>
              ...
              {/* Text-to-Speech */}
              <div className="group p-6 rounded-xl border border-blue-500/20 bg-blue-500/5 hover:bg-blue-500/10 transition-all">
                <div className="flex items-start gap-4">
                  <div className="p-3 rounded-lg bg-blue-500/20 text-blue-400 group-hover:text-blue-300">
                    <Volume2 className="h-6 w-6" />
                  </div>
                  <div className="flex-1">
                    <h3 className="font-semibold mb-2">Text-to-Speech Announcements</h3>
              ...
              <div className="group p-6 rounded-xl border border-cyan-500/20 bg-cyan-500/5 hover:bg-cyan-500/10 transition-all">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold mb-2">Follow Mode</h3>
              ...
              <div className="group p-6 rounded-xl border border-blue-500/20 bg-blue-500/5 hover:bg-blue-500/10 transition-all">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold mb-2">Smart Slash Commands</h3>
              ...
              <div className="group p-6 rounded-xl border border-cyan-500/20 bg-cyan-500/5 hover:bg-cyan-500/10 transition-all">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold mb-2">Intelligent Server Profiles</h3>
              ...
              <div className="group p-6 rounded-xl border border-blue-500/20 bg-blue-500/5 hover:bg-blue-500/10 transition-all">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold mb-2">XP & Leveling System</h3>
        ...
        <section className="relative px-4 py-16 sm:py-24">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold text-center mb-12">Advanced Progression System</h2>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold mb-2">Cloud-Ready & Scalable</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold mb-2">Stability & Performance</h3>
        ...
        <section className="relative px-4 py-16 sm:py-24">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl font-bold mb-6">Ready to Transform Your Discord Server?</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 px-8 py-3 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white font-semibold transition-all transform hover:scale-105 shadow-lg"
              >
                <Sparkles className="h-5 w-5" />
                Invite Now
              </a>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-cyan-500/10 border border-cyan-500/30 hover:bg-cyan-500/20 hover:border-cyan-500/50 text-cyan-400 font-medium transition-all"
              >
