          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 grid gap-10 md:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)] items-start">
            <div>
              ...
              <p className="mt-4 text-sm sm:text-base text-text-secondary leading-relaxed">
                GrayVally started as a solo studio, helping a handful of teams
                untangle slow, fragile products. Today we still operate like a
                tight strike team: small on purpose, opinionated about quality,
                and obsessed with the boring details that make everything else
                feel fast and effortless.
              </p>
              <p className="mt-4 text-sm sm:text-base text-text-secondary leading-relaxed">
                We sit in the space between &quot;agency&quot; and &quot;in‑house&quot;—close
                enough to care about your roadmap, independent enough to tell
                you when the foundations need rethinking.
              </p>
            </div>
              ...
              <dl className="space-y-3 text-sm sm:text-[15px]">
                <div className="flex gap-3">
                  ...
                  <dd>
                    ...
                    <p className="text-text-secondary mt-1">
                      Stable deployments, clear rollbacks, and observability before
                      animations. Pretty is good; predictable is non‑negotiable.
                    </p>
                  </dd>
                </div>
                <div className="flex gap-3">
                  ...
                  <dd>
                    ...
                    <p className="text-text-secondary mt-1">
                      Fewer status meetings, more written context. We treat every
                      integration and hand‑off like it will be read a year from
                      now.
                    </p>
                  </dd>
                </div>
                <div className="flex gap-3">
                  ...
                  <dd>
                    ...
                    <p className="text-text-secondary mt-1">
                      We design infrastructure so adding the next feature feels
                      cheaper, not more painful.
                    </p>
                  </dd>
                </div>
              </dl>
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="md:flex md:items-start md:justify-between md:gap-10">
              <div className="max-w-xl">
                ...
                <p className="mt-4 text-sm sm:text-base text-text-secondary leading-relaxed">
                  Whether we&apos;re owning a greenfield build or hardening an
                  existing product, the shape of the work is similar: understand
                  constraints, design a stable core, then move quickly on top of
                  it.
                </p>
              </div>
              ...
              <div className="mt-8 md:mt-0 grid gap-4 sm:gap-5 md:grid-cols-2">
                <div className="rounded-xl border border-border/70 bg-surface/60 p-4 sm:p-5">
                  ...
                  <p className="mt-2 text-xs sm:text-sm text-text-secondary">
                    We map out systems, failure modes, and goals so we&apos;re
                    solving the root problem, not just the visible bugs.
                  </p>
                </div>
                ...
                <div className="rounded-xl border border-border/70 bg-surface/60 p-4 sm:p-5">
                  ...
                  <p className="mt-2 text-xs sm:text-sm text-text-secondary">
                    Environments, CI/CD, monitoring, and data flows get designed
                    first so feature work can ship safely.
                  </p>
                </div>
                ...
                <div className="rounded-xl border border-border/70 bg-surface/60 p-4 sm:p-5">
                  ...
                  <p className="mt-2 text-xs sm:text-sm text-text-secondary">
                    We ship in small, observable slices with room for feedback,
                    rather than one huge &quot;big bang&quot; release.
                  </p>
                </div>
                ...
                <div className="rounded-xl border border-border/70 bg-surface/60 p-4 sm:p-5">
                  ...
                  <p className="mt-2 text-xs sm:text-sm text-text-secondary">
                    We leave behind documentation, dashboards, and patterns your
                    team can own, not fragile magic.
                  </p>
                </div>
              </div>
            </div>
