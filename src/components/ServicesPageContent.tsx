      ...
      <main className="min-h-screen bg-background">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6">
            ...
            >
              ...
              <p className="mt-6 text-base sm:text-lg md:text-xl text-text-secondary/90 leading-relaxed max-w-2xl mx-auto">
                From concept to deployment, we provide end-to-end services to build, scale, and maintain your digital
                infrastructure.
              </p>
            </motion.div>
        ...
        <section className="py-16 sm:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            ...
            >
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-text-primary">All Services</h2>
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8">
                    <div>
                      ...
                      <p className="text-sm text-text-secondary mt-1">{category.items.length} services available</p>
                    </div>
