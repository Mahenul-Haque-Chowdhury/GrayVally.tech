          ...
          <div className="space-y-8 text-text-secondary">
            <section>
              ...
              <p className="leading-relaxed">
                ...
                This policy is compliant with the Digital Security Act 2018 of
                Bangladesh and the Information and Communication Technology Act
                2006.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  ...
                  Name, email address, phone number, billing address, and other
                ...
                <li>
                  ...
                  Company name, business registration details, and project
                  requirements.
                </li>
                <li>
                ...
                <li>
                  ...
                  Records of correspondence, support tickets, and feedback.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  Complying with legal obligations under Bangladesh law
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                ...
                encryption, secure servers, and access controls. In accordance
                with the Digital Security Act 2018, we take all reasonable
                steps to ensure the security of your data.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  ...
                  Third-party vendors who assist in our operations (payment
                ...
                <li>
                  ...
                  When required by Bangladesh law, court order, or government
                  authorities.
                </li>
                <li>
                  <strong className="text-text-primary">
            ...
            <section>
              ...
              <p className="leading-relaxed">
                ...
                retention period is required by Bangladesh law. Project-related
                data may be retained for up to 5 years for legal and accounting
                purposes.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                ...
                providers are located. We ensure appropriate safeguards are in
                place to protect your data in accordance with this policy.
              </p>
            </section>
            ...
            <section className="pt-8 border-t border-border">
              <p className="text-sm">
                This Privacy Policy is governed by the laws of the People&apos;s
                Republic of Bangladesh, including the Digital Security Act 2018
