          ...
          <div className="space-y-8 text-text-secondary">
            <section>
              ...
              <p className="leading-relaxed">
                ...
                our services. This policy complies with the Information and
                Communication Technology Act 2006 of Bangladesh.
              </p>
            </section>
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-surface/50 border border-border">
                  ...
                  <p className="text-sm">
                    ...
                    secure areas access, and remembering your cookie
                ...
                <div className="p-4 rounded-lg bg-surface/50 border border-border">
                  ...
                  <p className="text-sm">
                    ...
                    preference, theme selection (dark/light mode), and other
                    customizations.
                  </p>
                </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm border border-border rounded-lg">
                  <thead className="bg-surface/50">
                    <tr>
                      <th className="px-4 py-3 text-left text-text-primary border-b border-border">
                        Cookie Name
                      </th>
                      <th className="px-4 py-3 text-left text-text-primary border-b border-border">
                        Purpose
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong className="text-text-primary">Google Fonts:</strong>{" "}
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  ...
                  When you first visit our site, you can choose which cookie
                ...
                <li>
                  ...
                  Visit the third-party service websites to opt out of their
                  cookies.
                </li>
              </ul>
              <p className="leading-relaxed mt-4">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong className="text-text-primary">Chrome:</strong> Settings
                  → Privacy and Security → Cookies
                </li>
                <li>
                  <strong className="text-text-primary">Firefox:</strong> Options
                  → Privacy &amp; Security → Cookies
                </li>
                <li>
                  <strong className="text-text-primary">Safari:</strong> Preferences
                  → Privacy → Cookies
                </li>
                <li>
                  <strong className="text-text-primary">Edge:</strong> Settings
            ...
            <section>
              ...
              <p className="leading-relaxed">
                ...
                consent at any time by clearing cookies from your browser or
            ...
            <section className="pt-8 border-t border-border">
              <p className="text-sm">
                This Cookie Policy is governed by the laws of the People&apos;s
                Republic of Bangladesh, including the Information and
                Communication Technology Act 2006 and the Digital Security Act
                2018.
              </p>
            </section>
          </div>
